...
mammal_lda_pca1 = lda(redlistCategory ~ DietPC1 + DietPC2 + DietPC3 + DietPC4 + DietPC5 + DietPC6 + DietPC7 + ForStrat.Value + Activity.Nocturnal + Activity.Crepuscular +  Activity.Diurnal + log_bodymass,data=mammal_train_df)

mammal_lda_pca1=predict(mammal_lda_pca1, mammal_test_df)

table(preds = mammal_lda_pca1$class, truth = mammal_test_df$redlistCategory)

mean(mammal_lda_pca1$class != mammal_test_df$redlistCategory)
...
#Only removing once activity variable
