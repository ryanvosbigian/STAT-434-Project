...
```{r matching MAMMAL species that didnt have a perfect match between the IUCN and EltonTraits databases}
...
```{r matching BIRDS that didnt have a perfect match between the IUCN and EltonTraits databases}
mammal_pred_df = read.csv("mammal_pred_df.csv")
