...
prop.table(table(bird_df$redlistCategory,bird_df$ForStrat.aerial),2)*100


prop.table(table(bird_df$redlistCategory,bird_df$PelagicSpecialist),2)*100

prop.table(table(bird_df$redlistCategory,bird_df$ForStrat.ground),2)*100


prop.table(table(bird_df$redlistCategory,bird_df$ForStrat.midhigh),2)*100
